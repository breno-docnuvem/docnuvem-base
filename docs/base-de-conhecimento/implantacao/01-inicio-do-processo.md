...
![Mensagem no grupo de Implantações com os dados da nova instância.](images/01-inicio-do-processo/01-mensagem-grupo-implantacoes.png)

Quando o plano contratado for **Enterprise**, o Igor também envia, na mesma mensagem, quais módulos foram contratados.

![Mensagem do Igor informando os módulos Enterprise contratados.](images/01-inicio-do-processo/02-modulos-contratados-enterprise-igor.png)
