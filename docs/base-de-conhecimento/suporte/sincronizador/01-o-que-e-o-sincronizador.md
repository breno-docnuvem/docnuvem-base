...
| Uso | Módulo comercial, vendido normalmente | Uso interno, só em casos pontuais (ver [Agente Docnuvem (robô)](../agente-docnuvem/index.md)) |
| Roda como | Serviço do Windows | Programa convencional ou serviço, conforme o caso |

## Onde o programa fica disponível

O repositório com o instalador, versões e changelog fica em: [drive.google.com/drive/folders/1nVb_sFIwXLARTo_iH96bG1mbHaNuXf_n](https://drive.google.com/drive/folders/1nVb_sFIwXLARTo_iH96bG1mbHaNuXf_n?usp=sharing) — ver [02 - Como se localizar no repositório](02-como-se-localizar-no-repositorio.md) para a estrutura de pastas.
...
- Próxima etapa: [02 - Como se localizar no repositório](02-como-se-localizar-no-repositorio.md)
