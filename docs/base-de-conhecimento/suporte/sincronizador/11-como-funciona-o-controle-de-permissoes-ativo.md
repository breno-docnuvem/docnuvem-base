...
Funcionalidade opcional, disponível desde 28/08/2026, estabilizada em 04/09/2026. Estas regras só valem depois que a empresa tiver marcado "Exigir usuário no sincronizador" (ver [10 - Ativar a exigência de usuário na empresa](10-ativar-a-exigencia-de-usuario-na-empresa.md)) **e** a máquina estiver vinculada a um usuário (ver [09 - Vincular cada máquina a um usuário](09-vincular-cada-maquina-a-um-usuario.md)). Fora isso, vale sempre o comportamento padrão (sincroniza tudo, para qualquer usuário da máquina).
...
Ícone roxo — ver [13 - Cores do ícone da bandeja](13-cores-do-icone-da-bandeja.md) e [15 - Solução de problemas](15-solucao-de-problemas.md).
...
- [10 - Ativar a exigência de usuário na empresa](10-ativar-a-exigencia-de-usuario-na-empresa.md) · [12 - Migrando máquinas aos poucos](12-migrando-maquinas-aos-poucos.md)
