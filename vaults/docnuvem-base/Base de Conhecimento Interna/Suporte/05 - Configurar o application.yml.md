...
Depois de descompactado o pacote na máquina do cliente (ver [[04 - Baixar e descompactar o pacote]]) — o arquivo vem com dados de desenvolvimento, é obrigatório trocar pelos dados da empresa antes de instalar o serviço.
...
> ⚠️ Cada empresa/instalação precisa do seu próprio `token` e `instancia`. Nunca reaproveitar o arquivo de outra empresa.
