...
Dúvidas técnicas sobre a API ou sobre uma integração específica de cliente: perguntar ao **Breno**. Se ele não estiver disponível, acionar o **Victor** — ver [[Plano de Contingência]].
